item_sa_mana_potion = class({})

function item_sa_mana_potion:CastFilterResult()
...
function item_sa_mana_potion:GetCustomCastError()
	return "sa_hud_error_mana_elixir_full_mana"
end

function item_sa_mana_potion:OnSpellStart()

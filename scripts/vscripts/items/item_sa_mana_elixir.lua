item_sa_mana_elixir = class({})

function item_sa_mana_elixir:CastFilterResult()
...
function item_sa_mana_elixir:GetCustomCastError()
	return "sa_hud_error_mana_elixir_full_mana"
end

function item_sa_mana_elixir:OnSpellStart()

item_sa_healing_elixir = class({})

function item_sa_healing_elixir:CastFilterResult()
...
function item_sa_healing_elixir:GetCustomCastError()
	return "sa_hud_error_healing_elixir_full_hp"
end

function item_sa_healing_elixir:OnSpellStart()

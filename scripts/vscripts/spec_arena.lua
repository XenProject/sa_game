print ('[SPEC_ARENA] spec_arena.lua' )
...
if GameMode == nil then
	print ( '[SPEC_ARENA] creating spec_arena game mode' )
	GameMode = class({})
end
...
function GameMode:InitGameMode()
	GameMode = self
	print('[SPEC_ARENA] Starting to load Spec_arena gamemode...')
	...
	print('[SPEC_ARENA] GameRules set')
	...
	print('[SPEC_ARENA] Done loading Spec_arena gamemode!\n\n')
end
...
function GameMode:PlayerConnect(keys)
	print('[SPEC_ARENA] PlayerConnect')
	DeepPrintTable(keys)
...
function GameMode:OnConnectFull(keys)
	print ('[SPEC_ARENA] OnConnectFull')
	DeepPrintTable(keys)
...
function GameMode:PostLoadPrecache()
	print("[SPEC_ARENA] Performing Post-Load precache")
...
function GameMode:OnFirstPlayerLoaded()
	print("[SPEC_ARENA] First Player has loaded")
end
...
function GameMode:OnAllPlayersLoaded()
	print("[SPEC_ARENA] All Players have loaded into the game")
end
...
function GameMode:OnHeroInGame(hero)
	print("[SPEC_ARENA] Hero spawned in game for first time -- " .. hero:GetUnitName())
...
function GameMode:OnGameInProgress()
	print("[SPEC_ARENA] The game has officially begun")
...
function GameMode:OnDisconnect(keys)
	print('[SPEC_ARENA] Player Disconnected ' .. tostring(keys.userid))
	DeepPrintTable(keys)
...
function GameMode:OnGameRulesStateChange(keys)
	print("[SPEC_ARENA] GameRules State Changed")
	DeepPrintTable(keys)
...
function GameMode:OnItemPickedUp(keys)
	print ( '[SPEC_ARENA] OnItemPurchased' )
	DeepPrintTable(keys)
...
function GameMode:OnPlayerReconnect(keys)
	print ( '[SPEC_ARENA] OnPlayerReconnect' )
	DeepPrintTable(keys)
end
...
function GameMode:OnNonPlayerUsedAbility(keys)
	print('[SPEC_ARENA] OnNonPlayerUsedAbility')
	DeepPrintTable(keys)
...
function GameMode:OnPlayerChangedName(keys)
	print('[SPEC_ARENA] OnPlayerChangedName')
	DeepPrintTable(keys)
...
function GameMode:OnPlayerLearnedAbility( keys)
	print ('[SPEC_ARENA] OnPlayerLearnedAbility')
	DeepPrintTable(keys)
...
function GameMode:OnAbilityChannelFinished(keys)
	print ('[SPEC_ARENA] OnAbilityChannelFinished')
	DeepPrintTable(keys)
...
function GameMode:OnPlayerLevelUp(keys)
	print ('[SPEC_ARENA] OnPlayerLevelUp')
	DeepPrintTable(keys)
...
function GameMode:OnRuneActivated (keys)
	print ('[SPEC_ARENA] OnRuneActivated')
	DeepPrintTable(keys)
...
function GameMode:OnPlayerTakeTowerDamage(keys)
	print ('[SPEC_ARENA] OnPlayerTakeTowerDamage')
	DeepPrintTable(keys)
...
function GameMode:OnPlayerPickHero(keys)
	print ('[SPEC_ARENA] OnPlayerPickHero')
	DeepPrintTable(keys)
...
function GameMode:OnTeamKillCredit(keys)
	print ('[SPEC_ARENA] OnTeamKillCredit')
	DeepPrintTable(keys)
...
function GameMode:OnEntityKilled( keys )
	print( '[SPEC_ARENA] OnEntityKilled Called' )
	DeepPrintTable( keys )
